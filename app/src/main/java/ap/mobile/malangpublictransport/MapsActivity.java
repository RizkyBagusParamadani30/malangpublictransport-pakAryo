...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private boolean shouldShowRouteList = false;
...
//end disini
    ...
    public void onMapLongClick(LatLng latLng) {
        ...
        showMemoryInfo();
        LatLng latlong = new LatLng(-7.971795618780245, 112.60223139077425);
        ...
        this.markerDestination = MapUtilities.drawMarker(
                this.mMap, latlong, BitmapDescriptorFactory.HUE_GREEN, "Destination", "Tap to show route\nto this location");
        ...
        // Reset the flag to false when onMapLongClick executes.
        shouldShowRouteList = false;
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        if (marker.getPosition().latitude == markerDestination.getPosition().latitude &&
            ...
            // Set the flag to true when the destination marker is clicked.
            shouldShowRouteList = true;
        }
        return false;
    }
    ...
    public void onSuccess(Location location) {
        ...
        this.mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(userLocation, 11f));
...
//        this.mMap.animateCamera(CameraUpdateFactory.newLatLngBounds(bounds, padding));
    ...
    public void onDijkstraComplete(ArrayList<RouteTransport> routes) {
        ...
        // Show the route list only if the user clicked on the destination marker.
        if (shouldShowRouteList) {
